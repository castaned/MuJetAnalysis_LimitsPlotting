...
#l_CMSLumi.SetMargin(0.13)
l_CMSLumi.SetHeader("20.7 fb^{-1} (8 TeV)")
#l_CMSLumi.Draw()

lumi_fbinv = 20.7 # fb-1
...
def limit_vs_mGammaD_2012():
#  print limit_vs_mGammaD_2012
  cnv.SetLogy(0)
...
#    mean = fCmsLimitVsM_explicit(m)
#    sigma = 0.0015*fCmsLimitVsM_explicit(m)
#    val = rnd.Gaus(mean, sigma)
#    print "[ ", m, ",", val, "],"
    
    array_mGammaD_limit.append(( m, fCmsLimitVsM(m) ))
    array_mGammaD_limit_explicit.append(( m, fCmsLimitVsM_explicit(m) ))
    ...
    array_mGammaD_limit_T2000.append(( m, fCmsLimitVsM_HybridNew(m, "T2000") ))
    array_mGammaD_limit_T2000_s777.append(( m, fCmsLimitVsM_HybridNew(m, "T2000_s777") ))
    limit_average = ( fCmsLimitVsM_HybridNew(m, "default") + fCmsLimitVsM_HybridNew(m, "T5000") + fCmsLimitVsM_HybridNew(m, "T50000") + fCmsLimitVsM_HybridNew(m, "T2000") + fCmsLimitVsM_HybridNew(m, "T2000_s777") )/5.0
    array_mGammaD_limit_average.append(( m, limit_average ))

  mGammaD_limit_T500_average = mGammaD_limit_T500_average / len(MGammaD_array)
  print "mGammaD_limit_T500_average = ", mGammaD_limit_T500_average
  
  mGammaD_limit_T5000_average = mGammaD_limit_T5000_average / len(MGammaD_array)
  print "mGammaD_limit_T5000_average = ", mGammaD_limit_T5000_average
  
  mGammaD_limit_T50000_average = mGammaD_limit_T50000_average / len(MGammaD_array)
  print "mGammaD_limit_T50000_average = ", mGammaD_limit_T50000_average
  
  mGammaD_limit_T500000_average = mGammaD_limit_T500000_average / len(MGammaD_array)
  print "mGammaD_limit_T500000_average = ", mGammaD_limit_T500000_average

#  print array_mGammaD_limit_average

#  h_limit_vs_mGammaD_dummy = ROOT.TH2F("h_limit_vs_mGammaD_dummy", "h_limit_vs_mGammaD_dummy", 1000, mGammaD_GeV_bot, mGammaD_GeV_top, 1000, 0.0, 6.0)
  h_limit_vs_mGammaD_dummy = ROOT.TH2F("h_limit_vs_mGammaD_dummy", "h_limit_vs_mGammaD_dummy", 1000, 0.0, 4.0, 1000, 0.0, 6.0)
#  h_limit_vs_mGammaD_dummy.SetXTitle("m_{#gamma_{D}} [GeV]")
...
#  gr_limit_vs_mGammaD_T500.Draw("L")
  
  gr_limit_vs_mGammaD_T2000 = ROOT.TGraph( len(array_mGammaD_limit_T2000), array.array("d", zip(*array_mGammaD_limit_T2000)[0]), array.array("d", zip(*array_mGammaD_limit_T2000)[1]) )
  gr_limit_vs_mGammaD_T2000.SetLineWidth(1)
  gr_limit_vs_mGammaD_T2000.SetLineColor(ROOT.kCyan)
  gr_limit_vs_mGammaD_T2000.SetLineStyle(1)
#  gr_limit_vs_mGammaD_T2000.Draw("L")
  
  gr_limit_vs_mGammaD_T2000_s777 = ROOT.TGraph( len(array_mGammaD_limit_T2000_s777), array.array("d", zip(*array_mGammaD_limit_T2000_s777)[0]), array.array("d", zip(*array_mGammaD_limit_T2000_s777)[1]) )
  gr_limit_vs_mGammaD_T2000_s777.SetLineWidth(1)
  gr_limit_vs_mGammaD_T2000_s777.SetLineColor(ROOT.kMagenta)
  gr_limit_vs_mGammaD_T2000_s777.SetLineStyle(1)
#  gr_limit_vs_mGammaD_T2000_s777.Draw("L")
...
#  gr_limit_vs_mGammaD_T5000.Draw("L")
...
#  gr_limit_vs_mGammaD_T50000.Draw("L")
...
#  gr_limit_vs_mGammaD.SetMarkerStyle(1)
...
#  l_limit_vs_mGammaD.AddEntry(gr_limit_vs_mGammaD_T2000,"Toys=2000","L")
#  l_limit_vs_mGammaD.AddEntry(gr_limit_vs_mGammaD_T2000_s777,"Toys=2000, seed=777","L")
...
#  cnv.Update()
  ...
  h_limit_vs_mGammaD_error_dummy = ROOT.TH2F("h_limit_vs_mGammaD_error_dummy", "h_limit_vs_mGammaD_error_dummy", 1000, 0.0, 4.0, 1000, -1.0, 1.0)
#  h_limit_vs_mGammaD_error_dummy.SetXTitle("m_{#gamma_{D}} [GeV]")
...
#  gr_limit_vs_mGammaD_T500_error.Draw("L")
...
#  gr_limit_vs_mGammaD_T50000_error.Draw("L")
  ...
  cnv.SaveAs("plots/PDF/limit_Events_vs_mGammaD_2012_FitUncert.pdf")
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/limit_Events_vs_mGammaD_2012_FitUncert.pdf -resize 900x900 plots/PNG/limit_Events_vs_mGammaD_2012_FitUncert.png")
  
#  h_limit_vs_mGammaD_dummy.Draw()
#  
#  gr_limit_vs_mGammaD_average = ROOT.TGraph( len(array_mGammaD_limit_average), array.array("d", zip(*array_mGammaD_limit_average)[0]), array.array("d", zip(*array_mGammaD_limit_average)[1]) )
#  gr_limit_vs_mGammaD_average.SetLineWidth(1)
#  gr_limit_vs_mGammaD_average.SetLineColor(ROOT.kRed)
#  gr_limit_vs_mGammaD_average.SetLineStyle(1)
#  gr_limit_vs_mGammaD_average.Draw("L")
#  
#  gr_limit_vs_mGammaD = ROOT.TGraph( len(array_mGammaD_limit), array.array("d", zip(*array_mGammaD_limit)[0]), array.array("d", zip(*array_mGammaD_limit)[1]) )
#  gr_limit_vs_mGammaD.SetLineWidth(1)
#  gr_limit_vs_mGammaD.SetLineColor(ROOT.kBlack)
#  gr_limit_vs_mGammaD.SetLineStyle(1)
#  gr_limit_vs_mGammaD.Draw("C")
#  
#  gr_limit_explicit_vs_mGammaD = ROOT.TGraph( len(array_mGammaD_limit), array.array("d", zip(*array_mGammaD_limit)[0]), array.array("d", zip(*array_mGammaD_limit)[1]) )
#  gr_limit_explicit_vs_mGammaD.SetLineWidth(1)
#  gr_limit_explicit_vs_mGammaD.SetLineColor(ROOT.kBlue)
#  gr_limit_explicit_vs_mGammaD.SetLineStyle(2)
#  gr_limit_explicit_vs_mGammaD.Draw("C")
#  
#  l_limit_vs_mGammaD_average = ROOT.TLegend(0.55,0.75,0.9,0.9)
#  l_limit_vs_mGammaD_average.SetFillColor(ROOT.kWhite)
#  l_limit_vs_mGammaD_average.SetMargin(0.13)
#  l_limit_vs_mGammaD_average.SetBorderSize(0)
#  l_limit_vs_mGammaD_average.SetTextFont(42)
#  l_limit_vs_mGammaD_average.SetTextSize(0.035)
#  l_limit_vs_mGammaD_average.SetHeader("95% CL Limits:")
#  l_limit_vs_mGammaD_average.AddEntry(gr_limit_vs_mGammaD_average,"Average","L")
#  l_limit_vs_mGammaD_average.AddEntry(gr_limit_vs_mGammaD,"Fit","L")
#  l_limit_vs_mGammaD_average.Draw()
#  
#  l_CMS.Draw()
#  l_CMSLumi.Draw()
#  
...
#  cnv.SaveAs("plots/PDF/limit_Events_vs_mGammaD_2012_average.pdf")
#  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/limit_Events_vs_mGammaD_2012_average.pdf -resize 900x900 plots/PNG/limit_Events_vs_mGammaD_2012_average.png")
  ...
  cnv.SaveAs("plots/PDF/limit_Events_vs_mGammaD_2012.pdf")
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/limit_Events_vs_mGammaD_2012.pdf -resize 900x900 plots/PNG/limit_Events_vs_mGammaD_2012.png")
...
def limit_CSxBR2xAlpha_fb_vs_mGammaD_2012():

  cnv.SetLogy(0)

  array_mGammaD_limit_CSxBR2xAlpha_fb = []
  for m in fRange(0.25, 3.55, 201):
    array_mGammaD_limit_CSxBR2xAlpha_fb.append(( m, fCmsLimitVsM(m)/lumi_fbinv/SF/eFullMc_over_aGen ))
#    array_mGammaD_limit_CSxBR2xAlpha_fb.append(( m, fCmsLimitVsM_HybridNew(m)/lumi_fbinv/SF/eFullMc_over_aGen ))

  h_limit_CSxBR2xAlpha_fb_vs_mGammaD_dummy = ROOT.TH2F("h_limit_CSxBR2xAlpha_fb_vs_mGammaD_dummy", "h_limit_CSxBR2xAlpha_fb_vs_mGammaD_dummy", 1000, 0.0, 4.0, 1000, 0.0, 6.0/lumi_fbinv/SF/eFullMc_over_aGen)
  h_limit_CSxBR2xAlpha_fb_vs_mGammaD_dummy.SetXTitle("m_{a} [GeV]")
#  h_limit_CSxBR2xAlpha_fb_vs_mGammaD_dummy.SetXTitle("m_{#gamma_{D}} [GeV/#it{c}^{2}]")
  h_limit_CSxBR2xAlpha_fb_vs_mGammaD_dummy.SetYTitle("#sigma(pp #rightarrow 2a + X) B^{2}(a #rightarrow 2 #mu) #alpha_{gen} [fb]")
#  h_limit_CSxBR2xAlpha_fb_vs_mGammaD_dummy.SetYTitle("#sigma(pp #rightarrow 2#gamma_{D} + X) B^{2}(#gamma_{D} #rightarrow 2 #mu) #alpha [fb]")
  ...
  #l_limit_CSxBR2xAlpha_fb_vs_mGammaD.SetHeader("NMSSM 95% CL Limits:")
...
#  txtHeader.Draw()
  ...
  cnv.SaveAs("plots/PDF/limit_CSxBR2xAlpha_fb_vs_mGammaD_2012.pdf")
  cnv.SaveAs("plots/C/limit_CSxBR2xAlpha_fb_vs_mGammaD_2012.C")
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/limit_CSxBR2xAlpha_fb_vs_mGammaD_2012.pdf -resize 900x900 plots/PNG/limit_CSxBR2xAlpha_fb_vs_mGammaD_2012.png")

################################################################################
#           Plot acceptance Alpha vs mGammaD: 0.25 < mGammaD < 1.0              
################################################################################

def Alpha_vs_mGammaD_2012():
  ...
  for m_GeV in fRange(0.25, 1.0, 101):
    array_Alpha_vs_mGammaD_ctau0mm_LinearFit.append((  m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.0, m_GeV ) ))
    array_Alpha_vs_mGammaD_ctau02mm_LinearFit.append(( m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.2, m_GeV ) ))
    array_Alpha_vs_mGammaD_ctau05mm_LinearFit.append(( m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.5, m_GeV ) ))
    array_Alpha_vs_mGammaD_ctau2mm_LinearFit.append((  m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 2.0, m_GeV ) ))
    array_Alpha_vs_mGammaD_ctau5mm_LinearFit.append((  m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 5.0, m_GeV ) ))
  ...
  array_Alpha_vs_mGammaD_ctau0mm_Marker.append((    0.25,  100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.0, 0.25  ) ))
  array_Alpha_vs_mGammaD_ctau0mm_Marker.append((    0.4,   100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.0, 0.4   ) ))
  for m_GeV in mGammaD_GeV:
    array_Alpha_vs_mGammaD_ctau02mm_Marker.append(( m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.2, m_GeV ) ))
    array_Alpha_vs_mGammaD_ctau05mm_Marker.append(( m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.5, m_GeV ) ))
    array_Alpha_vs_mGammaD_ctau2mm_Marker.append((  m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 2.0, m_GeV ) ))
    array_Alpha_vs_mGammaD_ctau5mm_Marker.append((  m_GeV, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 5.0, m_GeV ) ))
  
  h_Alpha_vs_mGammaD_dummy = ROOT.TH2F("h_Alpha_vs_mGammaD_dummy", "h_Alpha_vs_mGammaD_dummy", 1000, mGammaD_GeV_bot, mGammaD_GeV_top, 1000, 0.0, 18.0)
  ...
  gr_Alpha_vs_mGammaD_ctau0mm = ROOT.TGraph( len(array_Alpha_vs_mGammaD_ctau0mm), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau0mm)[0]), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau0mm)[1]) )
  ...
  gr_Alpha_vs_mGammaD_ctau02mm = ROOT.TGraph( len(array_Alpha_vs_mGammaD_ctau02mm), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau02mm)[0]), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau02mm)[1]) )
  ...
  gr_Alpha_vs_mGammaD_ctau05mm = ROOT.TGraph( len(array_Alpha_vs_mGammaD_ctau05mm), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau05mm)[0]), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau05mm)[1]) )
  ...
  gr_Alpha_vs_mGammaD_ctau2mm = ROOT.TGraph( len(array_Alpha_vs_mGammaD_ctau2mm), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau2mm)[0]), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau2mm)[1]) )
  ...
  gr_Alpha_vs_mGammaD_ctau5mm = ROOT.TGraph( len(array_Alpha_vs_mGammaD_ctau5mm), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau5mm)[0]), array.array("d", zip(*array_Alpha_vs_mGammaD_ctau5mm)[1]) )
  ...
  cnv.SaveAs("plots/PDF/Alpha_vs_mGammaD_2012.pdf")
  cnv.SaveAs("plots/C/Alpha_vs_mGammaD_2012.C")
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/Alpha_vs_mGammaD_2012.pdf -resize 900x900 plots/PNG/Alpha_vs_mGammaD_2012.png")

################################################################################
#           Plot acceptance Alpha vs ctau: 0.2 < ctau < 5.0                     
################################################################################

def Alpha_vs_ctau_2012():
  ...
  for ctau in fRange(ctau_mm_min, ctau_mm_max, 101):
    array_Alpha_vs_ctau_m025GeV.append(( ctau, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, 0.25 ) ))
    array_Alpha_vs_ctau_m04GeV.append((  ctau, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, 0.4 )  ))
    array_Alpha_vs_ctau_m1GeV.append((   ctau, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, 1.0 )  ))
  
  array_Alpha_vs_ctau_m025GeV_Marker = []
  array_Alpha_vs_ctau_m04GeV_Marker  = []
  array_Alpha_vs_ctau_m1GeV_Marker   = []
  for ctau in ctau_mm:
    array_Alpha_vs_ctau_m025GeV_Marker.append(( ctau, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, 0.25 ), 0.0, 100.0*fCmsDarkSusyAcceptance_LinearFitUnct_2012_8TeV( ctau, 0.25 ) ))
    array_Alpha_vs_ctau_m04GeV_Marker.append((  ctau, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, 0.4  ), 0.0, 100.0*fCmsDarkSusyAcceptance_LinearFitUnct_2012_8TeV( ctau, 0.4  ) ))
  
  # not in loop above becuase sample with mGammaD = 1 GeV and ctau = 0 mm is not yet generated as of April 8th, 2014
  array_Alpha_vs_ctau_m1GeV_Marker.append((    0.2,  100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.2,  1.0 ) ))
  array_Alpha_vs_ctau_m1GeV_Marker.append((    0.5,  100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.5,  1.0 ) ))
  array_Alpha_vs_ctau_m1GeV_Marker.append((    2.0,  100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 2.0,  1.0 ) ))
  array_Alpha_vs_ctau_m1GeV_Marker.append((    5.0,  100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 5.0,  1.0 ) ))
  
  h_Alpha_vs_ctau_dummy = ROOT.TH2F("h_Alpha_vs_ctau_dummy", "h_Alpha_vs_ctau_dummy", 1000, ctau_mm_bot, ctau_mm_top, 1000, 0.0, 18.0)
...
#  l_Alpha_vs_ctau.AddEntry(gr_Alpha_vs_ctau_m1GeV,  "m_{#gamma_{D}} =  1.0 GeV/#it{c}^{2}","L")
  ...
  cnv.SaveAs("plots/PDF/Alpha_vs_ctau_2012.pdf")
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/Alpha_vs_ctau_2012.pdf -resize 900x900 plots/PNG/Alpha_vs_ctau_2012.png")
...
def Alpha_vs_mGammaD_ctau_3D():
  ...
  for i_ctau in range(nBins):
    for i_m in range(nBins):
      ...
      rightPart = 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, m )
  ...
  for ctau in ctau_mm:
    for m in mGammaD_GeV:
      if ( ctau == 0 and m >= 0.55 ):
        ...
        array_Alpha_vs_mGammaD_ctau_3D_Marker.append(( m, ctau, 100.0*fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, m ) ))
...
def limit_CSxBR2_fb_vs_mGammaD_2012():
  ...
  for m in fRange(mGammaD_GeV_min, mGammaD_GeV_max, 101):
    prediction_CSxBR2_fb = 1000.0*fCS_SM_ggH_8TeV_pb(126.0)[0]*BR_h_to_2n1*BR_n1_to_gammaD_nD*BR_n1_to_gammaD_nD*BR_GammaD_to_2mu( m )*BR_GammaD_to_2mu( m )
    array_mGammaD_prediction_CSxBR2_fb.append((  m, prediction_CSxBR2_fb  ))
    array_mGammaD_limit_CSxBR2_fb_ctau0mm.append((  m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.0, m ) ))
    array_mGammaD_limit_CSxBR2_fb_ctau02mm.append(( m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.2, m ) ))
    array_mGammaD_limit_CSxBR2_fb_ctau05mm.append(( m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.5, m ) ))
    array_mGammaD_limit_CSxBR2_fb_ctau2mm.append((  m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 2.0, m ) ))
    array_mGammaD_limit_CSxBR2_fb_ctau5mm.append((  m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 5.0, m ) ))
  ...
  cnv.SaveAs("plots/PDF/limit_CSxBR2_fb_vs_mGammaD_2012.pdf")
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/limit_CSxBR2_fb_vs_mGammaD_2012.pdf -resize 900x900 plots/PNG/limit_CSxBR2_fb_vs_mGammaD_2012.png")

################################################################################
#       Plot Upper 95% CL Limit on CS vs mGammaD: 0.25 < mGammaD < 1.0       
################################################################################

def limit_CS_fb_vs_mGammaD_2012():
  ...
  for m in fRange(0.25, 1.0, 101):
    array_mGammaD_prediction_CS_fb.append((  m, 1000.0*fCS_SM_ggH_8TeV_pb(126.0)[0]*BR_h_to_2n1*BR_n1_to_gammaD_nD*BR_n1_to_gammaD_nD ))
    array_mGammaD_limit_CS_fb_ctau0mm.append((  m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.0, m )/BR_GammaD_to_2mu( m )/BR_GammaD_to_2mu( m ) ))
    array_mGammaD_limit_CS_fb_ctau02mm.append(( m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.2, m )/BR_GammaD_to_2mu( m )/BR_GammaD_to_2mu( m ) ))
    array_mGammaD_limit_CS_fb_ctau05mm.append(( m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 0.5, m )/BR_GammaD_to_2mu( m )/BR_GammaD_to_2mu( m ) ))
    array_mGammaD_limit_CS_fb_ctau2mm.append((  m, fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( 2.0, m )/BR_GammaD_to_2mu( m )/BR_GammaD_to_2mu( m ) ))
  ...
  cnv.SaveAs("plots/PDF/limit_CS_fb_vs_mGammaD_2012.pdf")
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/limit_CS_fb_vs_mGammaD_2012.pdf -resize 900x900 plots/PNG/limit_CS_fb_vs_mGammaD_2012.png")

################################################################################
#         Plot Upper 95% CL Limit on CSxBR2 vs ctau: 0.2 < ctau < 2.0            
################################################################################

def limit_CSxBR2_fb_vs_ctau_2012():
  ...
  for ctau in fRange(0.0, 2.0, 101):
    array_ctau_limit_CSxBR2_fb_m025GeV.append(( ctau, fCmsLimitVsM(0.25)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, 0.25 ) ))
    array_ctau_limit_CSxBR2_fb_m04GeV.append((  ctau, fCmsLimitVsM( 0.4)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, 0.4  ) ))
    array_ctau_limit_CSxBR2_fb_m1GeV.append((   ctau, fCmsLimitVsM( 1.0)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, 1.0  ) ))
  ...
  cnv.SaveAs("plots/PDF/limit_CSxBR2_fb_vs_ctau_2012.pdf")
  os.system("convert -define pdf:use-cropbox=true -density 300 plots/PDF/limit_CSxBR2_fb_vs_ctau_2012.pdf -resize 900x900 plots/PNG/limit_CSxBR2_fb_vs_ctau_2012.png")
...
def limit_CSxBR2_fb_and_CS_fb_and_CS_over_CSsm_vs_mGammaD_ctau_3D_and_2D():
  ...
  CSsm_fb = 1000.0 * fCS_SM_ggH_8TeV_pb(126.0)[0]
...
#  array_CS_over_CSsm_contourLevels = [0.0001, 0.000625, 0.0010, 0.0100, 0.1000]
  ...
  for i_ctau in range(nBins):
    for i_m in range(nBins):
      ...
      rightPart                    = fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, m )
  ...
  for i_logEpsilon2 in range(nBins):
    for i_m in range(nBins):
      ...
      if ctau > 0.0 and ctau < 2.0:
        rightPart_over_BR2_over_CSsm = fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, m ) / BR_GammaD_to_2mu( m ) / BR_GammaD_to_2mu( m ) / CSsm_fb
...
def limit_Lines_CSxBR2_fb_vs_mGammaD_ctau():
  ...
  for K in K_array:
    ...
    leftPart_fb = K * 1000.0*fCS_SM_ggH_8TeV_pb(126.0)[0]
    for m in fRange(mGammaD_GeV_min, mGammaD_GeV_max, 301):
      once = False
      for ctau in fRangeDecending(ctau_mm_max, ctau_mm_min, 301):
        rightPart_fb = fCmsLimitVsM(m)/lumi_fbinv/SF/fCmsDarkSusyAcceptance_LinearFit_2012_8TeV( ctau, m )
        if ctau > 0.0:
